package com.example.propertymanagement.filter;
...
// filters intercept request before reaching the controller
@Component
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    // we pass an Authorization header when we send it in postman
